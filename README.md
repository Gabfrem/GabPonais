...
| **Grammaire** | 22 leçons depuis zéro — particules, formes verbales, adjectifs, registres — chacune avec des exemples audio et deux questions à réussir pour valider. Sans elles, le vocabulaire reste une suite de mots isolés. |
| **Lectures** | Liens vers quatre ressources libres d'accès (Tadoku, NHK News Web Easy, yomujp, Aozora Bunko), débloquées selon le nombre de mots **vérifiés**. |
